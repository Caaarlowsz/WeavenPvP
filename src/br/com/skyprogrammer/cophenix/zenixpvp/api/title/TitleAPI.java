...
public class TitleAPI {
	...
	public TitleAPI(final String title, final String subtitle, final int fadeInTime, final int stayTime,
	...
	public void clearTitle(final Player playerToClear) {
		...
		final ProtocolInjector.PacketTitle localPacketTitle = new ProtocolInjector.PacketTitle(
	...
	public void sendToPlayer(final Player playerToSend) {
		...
		ProtocolInjector.PacketTitle packetTitle = new ProtocolInjector.PacketTitle(
				ProtocolInjector.PacketTitle.Action.TIMES, this.fadeInTime * (this.ticks ? 1 : 20),
		...
		localPlayerConnection.sendPacket((Packet) packetTitle);
		if (this.subtitle != "") {
			serializer = ChatSerializer.a("{text:\"" + ChatColor.translateAlternateColorCodes('&', this.subtitle)
