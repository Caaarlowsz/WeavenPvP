...
public final class Inventory1v1Custom implements Listener
{
    ...
    public static final void openCustomInventory(final Player bp, final Player customer) {
        ...
        if (Inventory1v1Custom.espada.containsKey(bp)) {
            if (Inventory1v1Custom.espada.get(bp) == Material.WOOD_SWORD) {
                custom.setItem(20, newItem(Material.WOOD_SWORD, "§6Espada de Madeira", new String[] { "§3Clique aqui para mudar", "§3o tipo de sua espada!", "" }));
            }
            else if (Inventory1v1Custom.espada.get(bp) == Material.STONE_SWORD) {
                custom.setItem(20, newItem(Material.STONE_SWORD, "§6Espada de Pedra", new String[] { "§3Clique aqui para mudar", "§3o tipo de sua espada!", "" }));
            }
            else if (Inventory1v1Custom.espada.get(bp) == Material.IRON_SWORD) {
                custom.setItem(20, newItem(Material.IRON_SWORD, "§6Espada de Ferro", new String[] { "§3Clique aqui para mudar", "§3o tipo de sua espada!", "" }));
            }
            else if (Inventory1v1Custom.espada.get(bp) == Material.DIAMOND_SWORD) {
                custom.setItem(20, newItem(Material.DIAMOND_SWORD, "§6Espada de Diamante", new String[] { "§3Clique aqui para mudar", "§3o tipo de sua espada!", "" }));
            }
        }
        if (Inventory1v1Custom.armaduras.containsKey(bp)) {
            if (Inventory1v1Custom.armaduras.get(bp) == "LEATHER") {
                custom.setItem(21, newItem(Material.LEATHER_CHESTPLATE, "§eArmadura de Couro", new String[] { "§3Clique aqui para mudar", "§3o tipo de sua armadura!", "" }));
            }
            else if (Inventory1v1Custom.armaduras.get(bp) == "IRON") {
                custom.setItem(21, newItem(Material.IRON_CHESTPLATE, "§eArmadura de Ferro", new String[] { "§3Clique aqui para mudar", "§3o tipo de sua armadura!", "" }));
            }
            else if (Inventory1v1Custom.armaduras.get(bp) == "DIAMOND") {
                custom.setItem(21, newItem(Material.DIAMOND_CHESTPLATE, "§eArmadura de Diamante", new String[] { "§3Clique aqui para mudar", "§3o tipo de sua armadura!", "" }));
            }
            else if (Inventory1v1Custom.armaduras.get(bp) == "SEM") {
                custom.setItem(21, newItem(Material.GOLD_HELMET, "§eSem Armadura", new String[] { "§3Clique aqui para mudar", "§3o tipo de sua armadura!", "" }));
            }
        }
        if (Inventory1v1Custom.recrafttype.containsKey(bp)) {
            if (Inventory1v1Custom.recrafttype.get(bp) == "COGUMELO") {
                custom.setItem(22, newItem(Material.RED_MUSHROOM, "§bRecrafts de Cogumelo", new String[] { "§3Clique aqui para mudar", "§3o tipo de seu recraft!", "" }));
            }
            else if (Inventory1v1Custom.recrafttype.get(bp) == "COCOABEAN") {
                custom.setItem(22, newItem(Material.COCOA, "§bRecrafts de Cocoabean", new String[] { "§3Clique aqui para mudar", "§3o tipo de seu recraft!", "" }));
            }
        }
        if (Inventory1v1Custom.recraft.containsKey(bp)) {
            if (Inventory1v1Custom.recraft.get(bp)) {
                custom.setItem(23, newItem(Material.BROWN_MUSHROOM, "§aCom Recraft", new String[] { "§3Clique aqui para", "§3desativar o recraft!", "" }));
            }
            else if (!Inventory1v1Custom.recraft.get(bp)) {
                custom.setItem(23, newItem(Material.MAGMA_CREAM, "§cSem Recraft", new String[] { "§3Clique aqui para", "§3ativar o recraft!", "" }));
            }
        }
        if (Inventory1v1Custom.sharpness.containsKey(bp)) {
            if (Inventory1v1Custom.sharpness.get(bp)) {
                custom.setItem(24, newItem(Material.ENCHANTED_BOOK, "§3Com sharpness", new String[] { "§3Clique aqui para", "§3tirar a afia\u00e7ao da espada!", "" }));
            }
            else if (!Inventory1v1Custom.sharpness.get(bp)) {
                custom.setItem(24, newItem(Material.BOOK, "§3Sem sharpness", new String[] { "§3Clique aqui para", "§3colocar afia\u00e7ao na espada!", "" }));
            }
        }
        if (Inventory1v1Custom.fullsoup.containsKey(bp)) {
            if (Inventory1v1Custom.fullsoup.get(bp)) {
                custom.setItem(29, newItem(Material.MUSHROOM_SOUP, "§2Full sopa", new String[] { "§3Clique aqui para", "§3usar 1 hotbar apenas", "" }));
            }
            else if (!Inventory1v1Custom.fullsoup.get(bp)) {
                custom.setItem(29, newItem(Material.BOWL, "§21 Hotbar", new String[] { "§3Clique aqui para", "§3usar full sopa", "" }));
            }
        }
    ...
    public final void onCustomItensChange(final InventoryClickEvent e) {
        if (e.getWhoClicked() instanceof Player) {
            ...
            if (e.getInventory().getName().equalsIgnoreCase("§c1v1 contra " + Inventory1v1Custom.playername.get(bp)) && e.getCurrentItem() != null) {
                ...
                if (e.getCurrentItem().getType() == Material.WOOL) {
                    ...
                    bp.sendMessage("§7Voc\u00ea enviou um desafio de 1v1 customizado para §b" + Inventory1v1Custom.playername.get(bp));
                    Bukkit.getPlayer((String)Inventory1v1Custom.playername.get(bp)).sendMessage("§eVoc\u00ea recebeu desafio de 1v1 customizado de §7" + bp.getName());
