...
public class AccountConfig {
	...
	public void register(final String nickNameToRegister) {
		this.getFile().set("Accounts.Pirate." + nickNameToRegister.toLowerCase() + ".NickName",
				(Object) nickNameToRegister);
		...
		this.getFile().set("Accounts.Pirate." + nickNameToRegister.toLowerCase() + ".Group",
				(Object) Tag.MEMBRO.toString());
	...
	public String getNameFormat(final String nickNameToGet) {
		final String nameFormatToGet = this.getFile()
				.getString("Accounts.Pirate." + nickNameToGet.toLowerCase() + ".NickName");
		return nameFormatToGet;
	}
	...
	public int getIntermediaryBox(final String nickNameToGet) {
		final int boxToGet = this.getFile()
				.getInt("Accounts.Pirate." + nickNameToGet.toLowerCase() + ".IntermediaryBox");
		return boxToGet;
	}
