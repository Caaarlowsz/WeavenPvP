...
public class FeastConfig {
	...
	public void addChest(final Location locationToAdd) {
		this.getFile()
				.set(String.valueOf(String.valueOf(locationToAdd.getBlockX()).replace(".", ",")) + "="
						+ String.valueOf(locationToAdd.getBlockY()).replace(".", ",") + "="
						+ String.valueOf(locationToAdd.getBlockZ()).replace(".", ",") + "="
						+ String.valueOf(locationToAdd.getPitch()).replace(".", ",") + "="
						+ String.valueOf(locationToAdd.getYaw()).replace(".", ",") + ".World",
						(Object) locationToAdd.getWorld().getName());
		this.save();
	}

	public void removeChest(final Location locationToRemove) {
		this.getFile()
				.set(String.valueOf(String.valueOf(locationToRemove.getBlockX()).replace(".", ",")) + "="
						+ String.valueOf(locationToRemove.getBlockY()).replace(".", ",") + "="
						+ String.valueOf(locationToRemove.getBlockZ()).replace(".", ",") + "="
						+ String.valueOf(locationToRemove.getPitch()).replace(".", ",") + "="
						+ String.valueOf(locationToRemove.getYaw()).replace(".", ","), (Object) null);
		this.save();
	}
