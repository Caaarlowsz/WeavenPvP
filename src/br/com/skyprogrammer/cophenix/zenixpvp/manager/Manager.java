...
public class Manager
{
    ...
    public Manager(final Handler instanceOfHandler) {
        ...
        this.instanceOfKitManager = new KitManager(this.instanceOfHandler).loadKits("br.com.skyprogrammer.cophenix.zenixpvp.kit.normal");
        ...
        new BukkitRunnable() {
            public void run() {
                ...
                for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
                    ...
                    TabAPI.setTabTitleToPlayer(localOnlinePlayers, "§6§lCELTZ §e§lKITPVP§eMoedas: §f" + wp.getMoney() + " §9§l- §ePing: §f" + integerOfPingMs + "\n§eNo momento temos §f" + integerOfOnlinePlayers + "§e jogadores no kitpvp!\n", "\n   §bNick: §f" + localOnlinePlayers.getName() + " §9§l- §bLiga: " + wp.getLeague().toString() + " §9§l- §bXP: §f" + wp.getXp() + "\n§bMais informa\u00e7\u00f5es em §f" + "www.celtzmc.com");
                }
            }
