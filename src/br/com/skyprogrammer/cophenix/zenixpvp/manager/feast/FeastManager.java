...
public class FeastManager
{
    ...
    public void broadcast(final int timeBeforeSpawn) {
        ...
        if (minutes <= 2 && seconds == 0) {
            Bukkit.broadcastMessage("§4§lFEAST§f ir\u00e1 spawnar em §e" + minutes + " minutos§7. Digite: §f/feast§7 para apontar a b\u00fassola.");
        }
        else if (minutes < 1 && seconds == 30) {
            Bukkit.broadcastMessage("§4§lFEAST§f ir\u00e1 spawnar em §e" + seconds + " segundos§7. Digite: §f/feast§7 para apontar a b\u00fassola.");
        }
            ...
            Bukkit.broadcastMessage("§4§lFEAST§f ir\u00e1 spawnar em §e" + seconds + " segundo§7. Digite: §f/feast§7 para apontar a b\u00fassola.");
        }
    }
    ...
    public static class FeastItems
    {
        ...
        private static List<ItemStack> addItem(final Material mat, final short durability, final int min, final int max) {
