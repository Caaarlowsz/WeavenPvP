...
public enum League
{
    ...
    SILVER("SILVER", 4, "§7§l\u2736", "§7§lSILVER", 6000, 8999), 
    GOLD("GOLD", 5, "§6§l\u2737", "§6§lGOLD", 9000, 12999), 
    ...
    private League(final String s, final int n, final String symbol, final String name, final int minXp, final int maxXp) {
        this.symbol = symbol;
        this.name = name;
        this.minXp = minXp;
        this.maxXp = maxXp;
