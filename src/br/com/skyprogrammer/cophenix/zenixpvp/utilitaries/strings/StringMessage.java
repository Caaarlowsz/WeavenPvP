...
{
    public static String createMessageFromArrayOfString(final int valueOfFirstArgsIndex, final String[] arrayOfStringToCreate, final String defaultMessageString) {
