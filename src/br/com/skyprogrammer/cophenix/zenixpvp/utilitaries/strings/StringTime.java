...
public class StringTime {
	...
	private static String fromLong(String stringToReturn, final long longToGetFrom) {
		...
		final long longOfMinutes = TimeUnit.SECONDS.toMinutes(longToGetFrom)
				- TimeUnit.SECONDS.toHours(longToGetFrom) * 60L;
		final long longOfSeconds = TimeUnit.SECONDS.toSeconds(longToGetFrom)
				- TimeUnit.SECONDS.toMinutes(longToGetFrom) * 60L;
		...
		stringToReturn = String.valueOf(stringFormatOfLongOfDaysValue) + stringFormatOfLongOfHoursValue
				+ stringFormatOfLongOfMinutesValue + stringFormatOfLongOfSecondsValue;
