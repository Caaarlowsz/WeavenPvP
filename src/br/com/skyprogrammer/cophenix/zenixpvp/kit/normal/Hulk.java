...
public class Hulk extends Kit {
	public Hulk() {
		super("Hulk", Material.SADDLE, 0, 4500, 12, true, new String[] { "", "Com seu item pegue seu oponente",
				"e coloque-o em sua cabe\u00e7a para", "poder hita-lo avontade sem ele", "poder hitar voc\u00ea." });
	}
