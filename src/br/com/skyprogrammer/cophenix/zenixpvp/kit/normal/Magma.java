...
{
    public Magma() {
        super("Magma", Material.WATER_BUCKET, 0, 9000, 0, true, new String[] { "", "N\u00e3o receba nenhum dano para elementos", "semelhantes a fogo e a cada hite em", "seus oponentes tenha 30% de chance", "deles pegarem fogo porem se estiver", "na agua voce recebe 3.50 de", "dano por segundo." });
    }
    ...
    public void onUpdateMagma(final UpdateEvent localUpdateEvent) {
        ...
        for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
            ...
            if (localGamer.getKit() == this) {
                final Location localLocation = localOnlinePlayers.getLocation().clone().add(0.0, -1.0, 0.0).add(0.0, 1.0, 0.0);
