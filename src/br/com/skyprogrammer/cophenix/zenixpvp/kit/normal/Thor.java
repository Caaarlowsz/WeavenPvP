...
{
    public Thor() {
        super("Thor", Material.GOLD_AXE, 0, 8000, 9, true, new String[] { "", "Com seu machado fa\u00e7a cair um raio", "para onde voce estiver olhando." });
    }
    ...
    public void onThor(final PlayerInteractEvent localPlayerInteractEvent) {
        ...
        if (localGamer.getKit() == this && localPlayer.getItemInHand().getType() == this.getMaterial()) {
            ...
            final Block blockToThor = localPlayer.getTargetBlock((HashSet)null, 100).getRelative(BlockFace.UP);
