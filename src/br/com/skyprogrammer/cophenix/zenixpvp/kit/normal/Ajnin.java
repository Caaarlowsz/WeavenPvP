...
public class Ajnin extends Kit
{
    ...
    public Ajnin() {
        super("Ajnin", Material.NETHER_STAR, 0, 7500, 10, true, new String[] { "", "D\u00ea um hit em seu oponente", "e ao agachar (shift) ele ser\u00e1", "teleportado para sua localiza\u00e7ao." });
    }
    ...
    public void onPlayerToggleSneak(final PlayerToggleSneakEvent localPlayerToggleSneakEvent) {
        ...
        if (localGamer.getKit() == this) {
            ...
            localPlayer.sendMessage("§2§l" + this.getName() + "§2 Voc\u00ea teleportou o player §f" + playerToTeleport.getName() + "§2 para sua localiza\u00e7\u00e3o!");
