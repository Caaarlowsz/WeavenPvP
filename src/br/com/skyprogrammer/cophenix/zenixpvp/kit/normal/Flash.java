...
{
    public Flash() {
        super("Flash", Material.REDSTONE_TORCH_ON, 0, 8500, 30, true, new String[] { "", "Com seu item teleporte para o", "lugar que voce aponta rapidamente." });
    }
    ...
    public void onPlayerInteract(final PlayerInteractEvent localPlayerInteractEvent) {
        ...
        if (localGamer.getKit() == this && localPlayer.getItemInHand().getType() == this.getMaterial()) {
            ...
            final Block localTargetBlock = localPlayer.getTargetBlock((HashSet)null, 200).getRelative(BlockFace.UP);
