...
public class ScoreboardAPI
{
    ...
    public static Objective registerNewObjectiveToScoreboard(final Scoreboard scoreboardToRegister, final String objectiveId, final String objectiveSubId, final DisplaySlot objectiveDisplaySlot, final String objectiveDisplayName) {
        final Objective newObjectiveToScoreboard = scoreboardToRegister.registerNewObjective(objectiveId, objectiveSubId);
    ...
    public static Objective getObjectiveFromScoreboard(final Scoreboard scoreboardToGet, final DisplaySlot objectiveDisplaySlot) {
    ...
    public static Team registerNewTeamToScoreboard(final Scoreboard scoreboardToRegister, final String teamId, final String defaultTeamPrefix, final String defaultTeamSuffix) {
