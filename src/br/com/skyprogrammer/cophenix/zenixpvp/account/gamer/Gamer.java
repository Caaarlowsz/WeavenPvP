...
public class Gamer
{
    ...
    public Gamer updateData() {
        if (this.isPremiumAccount) {
            Handler.getManager().getAccounts().getFile().set("Accounts.Premium." + this.gamerUniqueId + ".NickName", (Object)this.gamerName);
            Handler.getManager().getAccounts().getFile().set("Accounts.Premium." + this.gamerUniqueId + ".Kills", (Object)this.gamerKills);
            Handler.getManager().getAccounts().getFile().set("Accounts.Premium." + this.gamerUniqueId + ".Deaths", (Object)this.gamerDeaths);
            Handler.getManager().getAccounts().getFile().set("Accounts.Premium." + this.gamerUniqueId + ".KillStreak", (Object)this.gamerKillStreak);
            Handler.getManager().getAccounts().getFile().set("Accounts.Premium." + this.gamerUniqueId + ".SimpleBox", (Object)this.gamerSimpleBoxes);
            Handler.getManager().getAccounts().getFile().set("Accounts.Premium." + this.gamerUniqueId + ".IntermediaryBox", (Object)this.gamerIntermediaryBoxes);
            Handler.getManager().getAccounts().getFile().set("Accounts.Premium." + this.gamerUniqueId + ".AdvancedBox", (Object)this.gamerAdvancedBoxes);
            Handler.getManager().getAccounts().save();
        }
        else {
            Handler.getManager().getAccounts().getFile().set("Accounts.Pirate." + this.gamerName.toLowerCase() + ".NickName", (Object)this.gamerName);
            Handler.getManager().getAccounts().getFile().set("Accounts.Pirate." + this.gamerName.toLowerCase() + ".Kills", (Object)this.gamerKills);
            Handler.getManager().getAccounts().getFile().set("Accounts.Pirate." + this.gamerName.toLowerCase() + ".Deaths", (Object)this.gamerDeaths);
            Handler.getManager().getAccounts().getFile().set("Accounts.Pirate." + this.gamerName.toLowerCase() + ".KillStreak", (Object)this.gamerKillStreak);
            Handler.getManager().getAccounts().getFile().set("Accounts.Pirate." + this.gamerName.toLowerCase() + ".SimpleBox", (Object)this.gamerSimpleBoxes);
            Handler.getManager().getAccounts().getFile().set("Accounts.Pirate." + this.gamerName.toLowerCase() + ".IntermediaryBox", (Object)this.gamerIntermediaryBoxes);
            Handler.getManager().getAccounts().getFile().set("Accounts.Pirate." + this.gamerName.toLowerCase() + ".AdvancedBox", (Object)this.gamerAdvancedBoxes);
            Handler.getManager().getAccounts().save();
        }
        return this;
    }
